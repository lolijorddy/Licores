...
<li class="nav-item">
    <a class="nav-link collapsed" href="../../registreo_usuario.php">
        <span class="material-icons">people</span>
        <span>Registrar Usuario</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link collapsed" href="../../registrar_perfil.php">
        <span class="material-icons">people</span>
        <span>Registrar Perfil</span>
    </a>
</li>
<li class="nav-item">
    <a class="nav-link collapsed" href="../../visualiza_perfiles.php">
        <span class="material-icons">people</span>
        <span>Visualizar Perfiles</span>
    </a>
</li>
<li class="nav-item">
