...
#userList td {
    ...
    border: 1px solid #dddddd; /* Borde de la celda */
    text-align: left; /* Alineación del texto en el centro */
    font-size: 16px; /* Tamaño de fuente */
}
                                    ...
                                    if ($result) { // Verificar que la consulta se haya ejecutado correctamente
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td class='action-buttons'>
                                                    <a href='editar_usuario?id=" . $row['id'] . "'><i class='fas fa-edit'></i></a> |
                                                    <a href='borrar_usuario?id=" . $row['id'] . "' onclick=\"return confirm('¿Estás seguro de que deseas borrar este usuario?');\"><i class='fas fa-user-times'></i></a>
                                                  </td>";
                                            echo "</tr>";
                                            $numeroCorrelativo++;
                                        }
